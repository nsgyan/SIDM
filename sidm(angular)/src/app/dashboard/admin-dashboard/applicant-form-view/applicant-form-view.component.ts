...
@Component({
  selector: 'app-applicant-form-view',
  templateUrl: './applicant-form-view.component.html',
  styleUrls: ['./applicant-form-view.component.css']
})
export class ApplicantFormViewComponent implements OnInit {
  paymentDetails:any
  cat1 = true
  cat2 = true
  cat3 = true
