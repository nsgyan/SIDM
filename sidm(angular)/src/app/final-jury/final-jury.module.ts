...
import { FinalJuryRoutingModule } from './final-jury-routing.module';
...
@NgModule({
  declarations: [ViewAssessmentComponent,ViewApplicantComponent,ApplicantQuestionnaireComponent,ApplicantListComponent,AdminAssessorDashBoardComponent],
  imports: [
    CommonModule,
    FinalJuryRoutingModule,
    HttpClientModule,
    FormsModule,
    ReactiveFormsModule,
    RecaptchaModule,
